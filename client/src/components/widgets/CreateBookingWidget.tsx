...
export function CreateBookingWidget({ onBookingCreated }: { onBookingCreated?: () => void }) {
  ...
  const validateStep = (step: number): boolean => {
    ...
    return currentStepConfig.fields.every(field => {
      ...
      // This is a type-safe way to check fields in formData
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
            <div>
              <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
                {steps[currentStep].icon && <steps[currentStep].icon className="h-4 w-4 sm:h-5 sm:w-5" />}
            ...
            <Badge variant="secondary" className="text-xs px-2 py-1 self-start sm:self-auto">
        ...
        <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
            {currentStep === 0 && (
              <div className="space-y-4">
                <div>
                  <Label htmlFor="clientName" className="flex items-center gap-2 text-sm sm:text-base mb-2">
                ...
                <div>
                  <Label htmlFor="clientPhone" className="flex items-center gap-2 text-sm sm:text-base mb-2">
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                <div>
                  <Label htmlFor="pickup" className="flex items-center gap-2 text-sm sm:text-base mb-2">
                ...
                <div>
                  <Label htmlFor="dropoff" className="flex items-center gap-2 text-sm sm:text-base mb-2">
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                    ...
                    >
                      {passengerOptions.map((count) => (
                        <div key={count} className="flex items-center space-x-2">
                          <RadioGroupItem value={count} id={`passenger-res-${count}`} />
                          <Label
                            htmlFor={`passenger-res-${count}`}
                ...
                <div>
                  <Label htmlFor="notes" className="flex items-center gap-2 text-sm sm:text-base mb-2">
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="font-medium">{formData.passengers} {(formData.passengers || '1') === '1' ? 'Passenger' : 'Passengers'}</p>
                      </div>
